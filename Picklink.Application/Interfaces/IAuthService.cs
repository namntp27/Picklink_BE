...
public interface IAuthService
{
    ...
    Task<AuthResponse> ExternalLoginAsync(string provider, ExternalLoginRequest request, string? ipAddress, string? deviceInfo, CancellationToken cancellationToken = default);
}
